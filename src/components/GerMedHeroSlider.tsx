...
const SLIDES: SlideData[] = [
  {
    ...
    tabNumber: '01',
    tabLabel: 'Direct Manufacturer',
    tabSubtitle: 'Sialkot Master Forge',
    tagline: 'DIRECT SIALKOT MASTER FORGE • GERMAN STAINLESS STEEL (AISI 420)',
    headlinePart1: 'We Not Only Sell, But Also',
    headlineAccent: 'MANUFACTURE',
    headlinePart2: 'Our Surgical Instruments.',
    subheadline: 'Direct Forge Access • Zero Distributor Markups • ISO 13485 & CE Marked',
    description: 'Eliminate third-party broker fees. Medtrend supplies hospital-grade surgical instruments engineered directly in our Sialkot forging facility to operating rooms, healthcare systems, and surgeons worldwide.',
    specs: ['German AISI 420 Steel', '134°C Steam Autoclavable', 'ASTM F899 Metallurgy', '24h Express Dispatch'],
    videoSrc: '/3dslide1.mp4',
    posterSrc: '/images/home/home-1.jpg',
    primaryCtaText: 'Explore 15,000+ Instruments',
    primaryCtaTab: 'products',
    secondaryCtaText: 'Download OR Catalog (PDF)',
    secondaryCtaTab: 'quote',
    accentColor: '#1ab8ec',
    featuredProductCode: 'MT-HF-002',
    featuredProductName: 'Kelly Hemostatic Forceps 14cm',
    featuredProductPrice: 48.00,
    featuredProductBadge: 'OR Bestseller'
  },
  {
    id: 'custom-manufacturing',
    tabNumber: '02',
    tabLabel: 'Custom Blueprints',
    tabSubtitle: 'Bespoke Modifications',
    tagline: 'BESPOKE OEM SPECIFICATIONS & SURGEON MODIFICATIONS',
    headlinePart1: 'Custom Surgical Instrument',
    headlineAccent: 'Manufacturing & Blueprints',
    headlinePart2: 'Forged to Exact Specifications.',
    subheadline: 'Have a Unique Pattern in Mind? From CAD Blueprint to Sterile OR in 14 Days.',
    description: 'Need modified jaw angles, micro-serrations, specialized shank lengths, or titanium alloys? Our master toolmakers translate clinical sketches and 3D CAD prototypes into sterile, precision surgical tools.',
    specs: ['Bespoke Angles & Curvatures', 'Complimentary Fiber Laser UDI', 'Rapid 3D Prototyping', 'Low MOQ for Surgeons'],
    videoSrc: '/MT-HF-002-loop.mp4',
    posterSrc: '/images/home/home-2.jpg',
    primaryCtaText: 'Start Custom Project',
    primaryCtaTab: 'quote',
    secondaryCtaText: 'View OEM Capabilities',
    secondaryCtaTab: 'about',
    accentColor: '#eb5d0b',
  ...
  },
  {
    id: 'specialty-sets',
    tabNumber: '03',
    tabLabel: 'Specialty Sets',
    tabSubtitle: '15,000+ OR Patterns',
    tagline: 'TURNKEY PROCEDURAL TRAYS & SPECIALTY SURGICAL SETS',
    headlinePart1: 'Over 15,000+ Standardized',
    headlineAccent: 'Specialty Surgical Sets',
    headlinePart2: 'Ready for Immediate Deployment.',
    subheadline: 'Cardiovascular, Orthopedic, Ophthalmic Microsurgery & General Surgery Trays',
    description: 'Standardized surgical sets organized in heavy-duty perforated sterilization trays with medical-grade silicone positioning mats. Fully compliant with hospital sterile processing and autoclave cycles.',
    specs: ['Heavy-Duty Perforated Trays', 'Laser-Marked Silhouettes', 'DIN 58953 Steam Penetration', 'Custom Tray Layouts'],
    videoSrc: '/3dslide2.mp4',
    posterSrc: '/images/home/home-3.jpg',
    primaryCtaText: 'Browse Specialty Sets',
    primaryCtaTab: 'products',
    secondaryCtaText: 'Configure Custom Tray',
    secondaryCtaTab: 'quote',
    accentColor: '#38bdf8',
  ...
  },
  {
    ...
    tabNumber: '04',
    tabLabel: 'Lifetime Guarantee',
    tabSubtitle: 'ASTM F899 Passivated',
    tagline: 'TUNGSTEN CARBIDE GOLD SERIES & COMPREHENSIVE WARRANTY',
    headlinePart1: '5-Year Warranty &',
    headlineAccent: 'Lifetime Guarantee',
    headlinePart2: 'Against Defect & Fatigue.',
    subheadline: 'Rockwell HRC 68 Micro-Serrated Tungsten Carbide Inlays for Lifetime Cutting',
    description: 'Every Medtrend instrument undergoes triple-stage ultrasonic cleaning, nitric acid passivation per ASTM A967, and rigorous Rockwell hardness inspection. Guaranteed against corrosion, pitting, and joint failure.',
    specs: ['HRC 68 TC Gold Inlays', 'Nitric Passivation ASTM A967', 'Zero Corrosion Guarantee', 'Free Annual Refurbishment'],
    videoSrc: '/MT-HF-001-loop.mp4',
    posterSrc: '/surgical1.jpg',
    primaryCtaText: 'Shop TC Gold Series',
    primaryCtaTab: 'products',
    secondaryCtaText: 'View Certifications',
    secondaryCtaTab: 'compliance',
    accentColor: '#fbbf24',
...
const TRUST_ITEMS = [
  {
    ...
    desc: 'Zero broker markup • Direct Sialkot master forge',
    tag: 'FORGE DIRECT',
    targetTab: 'about'
  },
  {
    ...
    title: 'CUSTOM BLUEPRINTS & OEM',
    desc: 'From CAD drawings to sterile OR deployment in 14 days',
    tag: 'CAD TO OR',
    targetTab: 'quote'
  },
  {
    ...
    iconBg: 'rgba(26, 184, 236, 0.15)',
    iconBorder: 'rgba(26, 184, 236, 0.3)',
    title: '24–48H GLOBAL DISPATCH',
    desc: 'Priority express courier to USA, EU, GCC & worldwide',
    tag: 'EXPRESS DHL',
    targetTab: 'contact'
  },
  {
  ...
  },
  {
    ...
    title: 'ISO 13485 & CE MARKED',
    desc: 'Audited cleanroom QA & ASTM F899 surgical metallurgy',
    tag: 'MDR READY',
    targetTab: 'compliance'
  },
  {
    ...
    title: 'FREE FIBER LASER UDI',
    desc: 'Complimentary hospital insignia & sterile batch serials',
    tag: 'FREE ENGRAVING',
    targetTab: 'quote'
  }
];
...
const MFG_CAPABILITIES = [
  {
    id: 'sialkot-forge',
    icon: Factory,
    title: 'Sialkot Master Forge',
    subtitle: 'Direct In-House Hot Forging',
    badge: 'FORGE DIRECT',
    color: '#eb5d0b',
    bgColor: '#fff7ed',
    borderColor: '#fed7aa',
  ...
  },
  {
    id: 'optical-qa',
    icon: Microscope,
    title: '100% Optical QA Pass',
    subtitle: '40x Microscope Inspected',
    badge: 'ZERO DEFECT',
    color: '#195aa7',
    bgColor: '#eff6ff',
    borderColor: '#bfdbfe',
  ...
  },
  {
    id: 'rapid-oem',
    icon: Zap,
    title: '14-Day Rapid OEM',
    subtitle: 'Custom CAD to Sterile OR',
    badge: 'CAD TO OR',
    color: '#eb5d0b',
    bgColor: '#fff7ed',
    borderColor: '#fed7aa',
